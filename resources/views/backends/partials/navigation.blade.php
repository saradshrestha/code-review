<div class="header-container">
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="index.html"><img alt="logo" src="{{asset('backends/assets/img/90x90.jpg')}}"> <span class="navbar-brand-name">CORK</span></a>
        </div>
        ...
        <ul class="navbar-item flex-row nav-dropdowns">
            ...
            <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="media">
                        <img src="{{asset('backends/assets/img/90x90.jpg')}}" class="img-fluid" alt="admin-profile">
                        <div class="media-body align-self-center">
                            <h6><span>Hi,</span>{{Auth()->user()->name ?? 'User'}}</h6>
                        </div>
                    </div>
                ...
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="user-profile-dropdown">
                    <div class="">
                        ...
                        <div class="dropdown-item">
                            <a class="changeUserPassword" data-id = {{ Auth()->id() }}>
                        ...
                        <div class="dropdown-item">
                            <a class="" href="{{route('backend.logout')}}">
